...
public class NewJFrame5 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CONFORMATION MESSAGE");

        jLabel2.setText("Your Ride Has Been Booked Successfully !");

        jLabel3.setText("Details regarding Vechile and Driver will sent to your registered mobile number.");

        jLabel4.setText("Thanks For  Choosing Us.");
